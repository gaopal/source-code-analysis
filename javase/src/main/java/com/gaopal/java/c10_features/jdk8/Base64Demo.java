...
public class Base64Demo {
  public static void main(String args[]) {
    ...
    String base64encodedString =
        Base64.getEncoder().encodeToString("test?java8".getBytes(StandardCharsets.UTF_8));
    ...
    base64encodedString =
        Base64.getUrlEncoder().encodeToString("runoob?java8".getBytes(StandardCharsets.UTF_8));

package com.gaopal.pattern.builder.sql;

import com.gaopal.pattern.builder.sql.QueryRule.Rule;
...
public class QueryRuleSqlBuilder {
   ...
   */
  private void add(
      int andOr, String key, String split, String prefix, Object value, String suffix) {
    String andOrStr = (0 == andOr ? "" : (QueryRule.AND == andOr ? " and " : " or "));
    properties.add(
        CURR_INDEX, andOrStr + key + " " + split + prefix + (null != value ? " ? " : " ") + suffix);
    if (null != value) {

package com.gaopal.pattern.decorator.general;
...
public class Client {
  public static void main(String[] args) {
    ...
    Decorator decoratorBandA =
        new ConcreteDecoratorB(decoratorA); // 装饰器也可以装饰具体的装饰对象，此时相当于给对象在增加A的功能基础上在添加功能B
  ...
  abstract static class Decorator extends Component {
    /** 持有组件对象 */

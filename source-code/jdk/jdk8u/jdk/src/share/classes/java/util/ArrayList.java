 ...
 *
 * <p>The <tt>size</tt>, <tt>isEmpty</tt>, <tt>get</tt>, <tt>set</tt>, <tt>iterator</tt>, and
 ...
 * the <tt>LinkedList</tt> implementation.
 *
 * <p>Each <tt>ArrayList</tt> instance has a <i>capacity</i>. The capacity is the size of the array
 ...
 *
 * <p>An application can increase the capacity of an <tt>ArrayList</tt> instance before adding a
 * large number of elements using the <tt>ensureCapacity</tt> operation. This may reduce the amount
 ...
 *
 * <p>If no such object exists, the list should be "wrapped" using the {@link
 * Collections#synchronizedList Collections.synchronizedList} method. This is best done at creation
 * time, to prevent accidental unsynchronized access to the list:
 *
 * <pre>
 *   List list = Collections.synchronizedList(new ArrayList(...));</pre>
 *
 * <p><a name="fail-fast"> The iterators returned by this class's {@link #iterator() iterator} and
 * {@link #listIterator(int) listIterator} methods are <em>fail-fast</em>:</a> if the list is
...
public class ArrayList<E> extends AbstractList<E>
   ...
   * DEFAULTCAPACITY_EMPTY_ELEMENTDATA will be expanded to DEFAULT_CAPACITY when the first element
   * is added.
   */
  ...
  private void grow(int minCapacity) {
    ...
    // oldCapacity >> 1 是把 oldCapacity 除以 2 的意思, 即扩容后的大小是原来容量的1.5倍
   ...
   * index). This call shortens the list by {@code (toIndex - fromIndex)} elements. (If {@code
   ...
   * #lastIndexOf(Object)}, and all of the algorithms in the {@link Collections} class can be
   ...
   *
   * <p>The {@code Spliterator} reports {@link Spliterator#SIZED}, {@link Spliterator#SUBSIZED}, and
